                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm text-gray-500">
                                                        ...
                                                        <a href="{{ route('categories.show', $category->slug) }}" class="ml-1 text-indigo-600 hover:text-indigo-900" target="_blank">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <div class="flex justify-end space-x-2">
                                                        ...
                                                        <form method="POST" action="{{ route('admin.categories.destroy', $category->id) }}" class="inline" onsubmit="return confirm('Are you sure you want to delete this category? This action cannot be undone.');">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="text-red-600 hover:text-red-900" {{ $category->posts_count > 0 ? 'disabled title="Cannot delete category with posts"' : '' }}>
                                                                <svg class="h-5 w-5 {{ $category->posts_count > 0 ? 'opacity-50' : '' }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
